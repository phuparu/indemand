...
const FaqItem = ({item}) => {
    ...
    border-[#D9DCE2] mb-5 cursor-pointer'>
      ...
      onClick={toggleAccordion}>
        ...
        lg:text-[22px] lg:leading-8 text-headingColor'>{item.question}</h4>

        <div className={'${isOpen } w-7 h-7 lg:w-8 lg:h-8 border border-solid border-[#141F21] rounded flex items-center justify-center'}>
